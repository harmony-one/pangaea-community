...
$debug_output = shell_exec('tac ' . $node_path . '/latest/*.log  | grep -m 25 "debug" | sed "s@\b49\.176\.161\.107\b@xxx.xxx.xxx.xxx@g"  ');
$error_output = shell_exec('tac ' . $node_path . '/latest/zero*.log  | grep -m 50 "error" | sed "s@\b49\.176\.161\.107\b@xxx.xxx.xxx.xxx@g"  ');
$bingo_output = shell_exec('tac ' . $node_path . '/latest/zero*.log  | grep -a "BINGO" | sed "s@\b49\.176\.161\.107\b@xxx.xxx.xxx.xxx@g"  ');
...
<div class="col-lg-12 mt-2">
  <div class="row">
    <div class="col-md">
      <h1 class="text-left"><span class="badge badge-dark">Shard: <?= $shard_output ?></span></h1>
    </div>
    <div class="col-md">
      <h1 class="text-center"><span class="badge badge-dark">Page Refreshed: <?= $udate ?></span></h1>
    </div>
    <div class="col-md">
      <h1 class="text-right"><span class="badge badge-dark">Block: <?= $block_output ?></span></h1>
    </div>
  </div>
